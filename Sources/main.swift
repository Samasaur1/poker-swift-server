...
// private class __Q<Element: Sendable>: @unchecked Sendable {
//     private var arr: [Element] = []
//
//     func enqueue(_ e: Element) {
//         arr.append(e)
...
// }
//
// private actor QWrapper<Element: Sendable> {
//     private let q: __Q<Element>
//
//     init(_ q: __Q<Element>) { self.q = q }
//
//     func enqueue(_ e: Element) {
//         q.enqueue(e)
//     }
...
// }
//
// private struct ___Q<Element: Sendable> {
//     private actor Input {
//         nonisolated private let q = __Q<Element>()
//
//         func enqueue(_ e: Element) {
//             q.enqueue(e)
//         }
//
//         nonisolated func dequeue() -> Element {
//             if let e = q.dequeue() {
//                 return e
//             }
//
...
//
//     mutating func enqueue(_ e: Element) async {
//         await input.enqueue(e)
//     }
//
//     mutating func dequeue() async -> Element {
//         return await output.dequeue()
//     }
// }
//
// private struct _Q<Element: Sendable> {
//     private actor Input {
//         weak private var output: Output? = nil
//
//         private var arr: [Element] = []
//
//         func enqueue(_ e: Element) {
...
//     }
//     private actor Output {
//         nonisolated private var arr: [Element] = []
//         nonisolated func enqueue(_ e: Element) {
//             arr.append(e)
//         }
//
//         func dequeue() -> Element {
...
// }
//
// private struct Q<Element> {
//     private var arr: [Element] = []
//     private var continuation: CheckedContinuation? = nil
//
//     mutating func enqueue(_ e: Element) {
//         arr.append(e)
//     }
//
//     mutating func dequee() async -> Element? {
//         if arr.isEmpty {
...
//
//
// // let cpus = CommandLine.arguments.dropFirst().compactMap { URL(fileURLWithPath: $0) }
// //
// // print("Detected \(cpus.count) CPU(s):")
// // for cpu in cpus {
// //     print(cpu.absoluteString)
// // }
// //
// // let cpuProcesses = cpus.map { u in
// //     let p = Process()
// //     p.executableURL = u
